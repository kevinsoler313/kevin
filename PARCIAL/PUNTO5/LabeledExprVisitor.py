...
class LabeledExprVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by LabeledExprParser#FuncCall.
    ...
    # Visit a parse tree produced by LabeledExprParser#Power.
    def visitPower(self, ctx:LabeledExprParser.PowerContext):
        return self.visitChildren(ctx)
